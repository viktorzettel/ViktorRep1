#!/usr/bin/env python3
"""Replay-only ultra-safe candidate plus light late-window near-strike veto."""
...
CANDIDATE_NAME = "xrp_only_ultra_safe_v1_near_strike_light"
CANDIDATE_DESCRIPTION = (
    "Replay-only ultra-safe plus hard XRP near-strike veto: 30s<0.0003, 10s<0.0005."
)

#!/usr/bin/env python3
"""Replay-only v2 candidate plus conservative late-window near-strike veto."""
...
CANDIDATE_NAME = "xrp_only_cap98_required_context_v2_near_strike_conservative"
CANDIDATE_DESCRIPTION = (
    "Replay-only v2 plus hard XRP near-strike veto: 30s<0.0004, 10s<0.0006."
)

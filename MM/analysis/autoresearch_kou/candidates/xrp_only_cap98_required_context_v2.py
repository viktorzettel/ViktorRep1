#!/usr/bin/env python3
"""
XRP-only cap98 candidate that requires live clean-path context.

This is the production-shadow version of xrp_only_cap98_v1. The main difference
is defensive: missing execution/regime fields are no longer treated as safe.
"""
...
CANDIDATE_NAME = "xrp_only_cap98_required_context_v2"
CANDIDATE_DESCRIPTION = (
    "XRP-only paper candidate with required clean-path context, train-only XRP "
...
def score_grid_event(row: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {"allow_trade": True, "reason": "xrp_clean_path_entry_cap98_required_context"}

...
import { fetchSentiment } from './services/apiService';
import type { SentimentData } from './types';
import BtcIcon from './components/icons/BtcIcon';
import LoadingSpinner from './components/LoadingSpinner';
import SourceCard from './components/SourceCard';

// Simple markdown-to-HTML converter for this specific demo.
// It supports ### headers, bullet points (*) and bold text (**text**).
              ...
              <div className="animate-fade-in space-y-6">
                <div className="p-4 bg-slate-900/60 rounded-lg">
                  <h2 className="text-2xl font-semibold text-amber-400 mb-2">
                    Sentiment Score: {sentimentData.score.toFixed(1)} / 10
                  </h2>
